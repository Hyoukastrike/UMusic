...
public class MusicFragment extends Fragment {
    ...
    private RecyclerView rvMusicFragment;
    ...
    private void InitUi(View view) {
        ...
        imgMusicPlaylist = view.findViewById(R.id.img_music_playlist);
        tvMusicPlaylist = view.findViewById(R.id.tv_music_playlist);
        rvMusicFragment = view.findViewById(R.id.rv_music_fragment);

        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext(),RecyclerView.VERTICAL,false);
        rvMusicFragment.setLayoutManager(linearLayoutManager);
    }
    ...
    private void getListMusicFromRealTimeDatabase(){
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                rvMusicFragment.setAdapter(mMusicPlaylistAdapter);
